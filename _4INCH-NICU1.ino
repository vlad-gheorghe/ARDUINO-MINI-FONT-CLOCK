...
digitalWrite(buzzer, LOW);
    printText("TEMPERATURE", GREEN,30,85,1);  // Temperature Static Text
...
digitalWrite(buzzer, HIGH);
   ...
   printText(timeChar, RED,xa+7,ya,1);
}
else
{
if (al%2 == 0)
...
if (al%2 == 1)
{
  ...
  if(minuteNow!=minutePrevious || initial)
  {
    ...
    tft.fillRect(0,0,160,65,BLACK);
  //  printText(timeChar, WHITE,20,25,3);
    printText(timeChar, YELLOW,5,25,4);
  ...
  if(temperature != previousTemperature)
  {
    ...
    tft.fillRect(0,98,128,27,BLACK);
    printText(temperatureChar, WHITE,10,100,3);
    printText("o", WHITE,90,95,2);
    printText("C", WHITE,105,100,3);
...
//     printText("o", WHITE,62,35,1);
     printText("o", YELLOW,62,28,1);
     printText("o", YELLOW,62,35,1);

delay(500);
     printText("o", BLACK,62,28,1);
     printText("o", BLACK,62,35,1);
...
if (zz1 == 1) printText("1 - Monday", RED,10,80,1);  // Temperature Static Text
if (zz1 == 2) printText("2 - Tuesday", RED,10,80,1);  // Temperature Static Text
if (zz1 == 3) printText("3 - Wednesday", RED,10,80,1);  // Temperature Static Text
if (zz1 == 4) printText("4 - Thursday", RED,10,80,1);  // Temperature Static Text
if (zz1 == 5) printText("5 - Friday", RED,10,80,1);  // Temperature Static Text
if (zz1 == 6) printText("6 - Saturday", RED,10,80,1);  // Temperature Static Text
if (zz1 == 0) printText("0 - Sunday", RED,10,80,1);  // Temperature Static Text  
    delay(50);
